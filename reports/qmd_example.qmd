...
have had the highest horse populations in Canada. All provinces have had a decline in horse populations since 1940. 
...
We present the standard deviations in @tbl-hourses_sd.

```{python}
#| label: tbl-hourses_sd
...
Additionally, note that in @tbl-hourses_sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.
